...
\begin{figure}{\linewidth}
    ...
    \vspace{0.2cm}
    \includegraphics[width=0.85\textwidth]{imagens/fases_ml.png} % Mude para o nome do seu arquivo
...
\begin{figure}{\linewidth}
    ...
    \vspace{0.2cm}
    \includegraphics[width=0.85\textwidth]{imagens/faninfanoutcycle.png}
...
\begin{figure}{\linewidth}
    \centering
    \includegraphics[width=0.95\linewidth]{imagens/HI_Medium_ablation_metric_comparison.png}
...
\begin{figure}{\linewidth}
    \centering
    \includegraphics[width=0.85\linewidth]{imagens/HI_Medium_entity_level_recall.png}
