...
\end{equation}
Onde $\sigma_{st}$ é o número total de caminhos mais curtos de $s$ para $t$, e $\sigma_{st}(v)$ é o número desses caminhos que passam obrigatoriamente por $v$. Na lavagem de dinheiro, contas de ofuscação atuam frequentemente como pontes entre diferentes aglomerados da rede \cite{freeman1977set}.
...
A detecção de comunidades visa particionar o grafo em subconjuntos de vértices densamente conectados internamente e esparsamente conectados com o restante da rede \cite{liu2019evaluation}.
\begin{itemize}
