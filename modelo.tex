...
\begin{table}{\linewidth}
    ...
    \begin{tabular}{lcccc}
        ...
        \textbf{Métrica} & \textbf{Baseline} & \textbf{Full Model} & \textbf{Lift} & \textbf{Lift (\%)} \\
        \hline
        Acurácia & 0.8803 & 0.9204 & +0.0401 & +4.56\% \\
        AUPRC & 0.3197 & 0.3544 & +0.0347 & +10.85\% \\
        ROC-AUC & 0.9401 & 0.9572 & +0.0171 & +1.82\% \\
        F1-Score & 0.1585 & 0.1983 & +0.0398 & +25.11\% \\
        Precisão & 0.0875 & 0.1136 & +0.0261 & +29.83\% \\
        Recall & 0.8379 & 0.8034 & -0.0345 & -4.12\% \\
        \hline
        P@100 & 0.9800 & 1.0000 & +0.0200 & +2.04\% \\
        P@200 & 0.9850 & 1.0000 & +0.0150 & +1.52\% \\
        P@300 & 0.9800 & 1.0000 & +0.0200 & +2.04\% \\
        P@500 & 0.9840 & 1.0000 & +0.0160 & +1.63\% \\
        \hline
    \end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{Viabilidade computacional:} A redução do conjunto de \textit{features} de 49 para 43 atributos no HI Small, com manutenção (e leve ganho) de desempenho, melhora a relação custo-benefício do pipeline e amplia sua viabilidade operacional.
\end{itemize}
